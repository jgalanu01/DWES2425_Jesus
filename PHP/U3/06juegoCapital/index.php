    ...
    if (!empty($_POST['respuesta'])) {
        ...
        foreach ($preguntasFichero as $p) {
            if ($p->getId() == $_POST['validar']) {
                ...
                // Comprobar si las respuestas son iguales. Comprobamos siempre en minúsculas
    ...
    <table>
        <tr>
            ...
            <td style="padding-left: 20px;">
                <?php
                $aciertos = isset($_SESSION['aciertos']) ? $_SESSION['aciertos'] : 0;
