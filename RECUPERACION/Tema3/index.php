...
?>
    ...
    <body>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                ...
                                <!--2.Ejercicio-->
                                <input type="color" name="color" value=<?php echo (isset($_COOKIE['color']) ? $_COOKIE['color'] : '0') ?> /> <!--si hay cookie, su color, si no 0-->
        ...
        } //Si esta loggeado muestra hasta aquí
        ?>
    </body>
...
} //Si hay conexión pinta hasta aquí, pinta todo
