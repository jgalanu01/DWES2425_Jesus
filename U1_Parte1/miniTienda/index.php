...
<body>
    ...
    <div>
        ...
        <option>Camiseta Real Madrid - 100</option>
        <option>Camiseta FC Barcelona - 5</option>
        <option>Camiseta Atlético de Madrid - 5</option>
        <option>Chandal Real Madrid - 60</option>
</select>
