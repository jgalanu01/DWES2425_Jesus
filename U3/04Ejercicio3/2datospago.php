...
function comprobarCheck($texto){
    ...
    //Devuelve checked si está guardada la cookie y si no, siempre para transferencia
...
<body>
    <form action="tratarCookies.php" method="post">
        ...
        <input type="radio" name="tipo" <?php echo comprobarCheck('Contrareembolso')?> value="Contrareeembolso" />Contraereembolso
